...
public class TestBench {
	...
	/**
	 * Developed version of the test method in which the values are printed in a
	 * document
	 * 
	...
	/**
	 * Developed version of the test method in which the values are printed in a
	 * document In his new version we get to determine the number of samples
	 * 
	 * @param outputFileName
	 * @param startN
	 * @param endN
	 * @throws Exception
	 */
	public static void test(String outputFileName, int samples, int startN, int endN, String className,
	...
	/**
	 * private method used to implement reflection so the methods can be loaded
	 * dynamically
	 * 
	 * @param className
	 * @param methodName
	 ...
	 * @throws Exception
	 */
	private static void testAlgorithm(String className, String methodName, long n) throws Exception {
		Class<?> myClass = null;
